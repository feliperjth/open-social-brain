...
const themeNetworkDescriptionsEs = {
  "self-mentalizing": "Imaginar qué piensa o siente otra persona exige coordinar memoria personal, narrativa del yo y capacidad de cambiar perspectiva. DMN, vmPFC, hipocampo y TPJ forman esta red: qué sé yo, qué puede saber el otro, y qué diferencia existe entre ambos puntos de vista.",
  "person-perception": "Un rostro tarda menos de 200 ms en activar identidad, emoción y expectativa social. Vía visual, fusiforme, corteza auditiva, amígdala y TPJ transforman datos sensoriales en una presencia social completa: quién es esa persona, cómo está y qué cabe esperar de ella.",
  "emotion-empathy": "Antes de que la situación sea interpretada, ya fue sentida: tensión, malestar, algo que sube o baja en el cuerpo. Ínsula, amígdala, cíngulo anterior y red de saliencia transforman esas señales en prioridades afectivas, haciendo del cuerpo el primer filtro de lo que importa socialmente.",
  "regulation-control": "Cuando impulso y norma entran en tensión —inhibir una reacción, proteger reputación, actuar según una regla que no conviene en ese momento— esta red sostiene el control. DLPFC, vmPFC, cíngulo anterior y red de saliencia trabajan para que la respuesta sea deliberada, no automática.",
  "moral-ethics": "Un dilema moral no se resuelve con un solo sistema: hay emoción, norma, intención y cálculo de consecuencias. La negociación ocurre entre vmPFC, DLPFC, cíngulo anterior y amígdala, con DMN simulando intención y responsabilidad. El resultado es un equilibrio dinámico más que una conclusión lógica.",
  "self-representation": "El yo no es una fotografía fija: se reconstruye continuamente entre memoria, cuerpo, valor personal y comparación social. DMN, vmPFC, hipocampo e ínsula mantienen esa construcción activa, coherente y disponible para orientar decisiones e identidad.",
  "action-imitation": "Ver a alguien moverse activa, en el propio sistema motor, un mapa de esa acción. Premotora, parietal, cerebelo y TPJ no copian automáticamente: deciden cuándo imitar, cuándo coordinarse y cuándo inhibir, haciendo de la imitación una forma de percepción orientada a la acción.",
  "reward-bonding": "Aprobación, cercanía, pertenencia: pueden adquirir el mismo peso motivacional que las recompensas materiales. Circuitos estriatales, vmPFC, amígdala e hipocampo aprenden quién importa, por qué, y cómo volver hacia esa persona o grupo.",
  "attachment-bond": "Una persona cercana puede bajar la respuesta al estrés, reducir percepción de amenaza y cambiar cómo se exploran situaciones nuevas. vmPFC, estriado, amígdala, ínsula e hipocampo convierten el vínculo en un regulador biológico, no solo psicológico.",
  "social-threat-stress": "La amenaza social activa reputación, cuerpo y predicción a la vez. Amígdala, ínsula, cíngulo anterior y saliencia registran y amplifican el peligro; DLPFC y vmPFC intentan modular la respuesta y reinterpretar la situación antes de que el daño sea irreversible.",
  "loneliness-isolation": "No es estar solo: es creer que el lugar propio en el mundo social es incierto o negativo. DMN, amígdala, ínsula, vmPFC y cíngulo anterior sesgan la predicción hacia rechazo, amplifican señales de exclusión y mantienen vigilancia aunque la señal externa sea ambigua.",
  "support-health": "Saber que hay alguien puede cambiar dolor, estrés y recuperación emocional antes de que ocurra algo. vmPFC reinterpreta seguridad, DLPFC sostiene regulación, cíngulo e ínsula monitorean malestar, y la amígdala puede reducir respuesta defensiva cuando la señal social es de apoyo.",
  "culture-social-cognition": "La cultura no es solo contexto: cambia qué señales sociales captan atención, qué se recuerda y cómo se valora el yo respecto al grupo. DMN, vmPFC, TPJ, hipocampo, fusiforme y DLPFC forman la red sobre la que opera ese aprendizaje cultural acumulado.",
  "social-norms-conformity": "Cuando la propia respuesta no coincide con lo que el grupo espera, hay un costo: detección de error, ajuste conductual o supresión del impulso. Cíngulo anterior, DLPFC, vmPFC y estriado procesan esa tensión entre lo que uno quiere hacer y lo que conviene hacer.",
  "altruism-prosocial": "Ayudar puede venir por caminos distintos: empatía que empuja desde adentro, norma que establece lo correcto, reputación que orienta la decisión o cuidado genuino. vmPFC, estriado, ínsula, cíngulo anterior, TPJ y DMN no operan igual en cada caso, lo que hace del altruismo una conducta con múltiples raíces.",
  "first-impressions": "La primera impresión ocurre antes de la deliberación: en menos de un segundo, fusiforme, amígdala, TPJ, vmPFC y corteza visual ya combinaron percepción y valoración para producir una respuesta afectiva y social inicial.",
  "joint-attention-gaze": "Seguir la mirada de otro es uno de los actos sociales más básicos y automáticos. Corteza visual, fusiforme, TPJ, parietal y amígdala funcionan como cadena: de la dirección de los ojos al objeto compartido, ajustando en cada paso el significado afectivo de lo que se señala.",
  "perspective-taking": "Tomar perspectiva no es solo imaginar: exige suprimir el propio punto de vista y construir uno alternativo. TPJ, DMN, parietal, DLPFC y vmPFC trabajan juntos para hacer ese cambio de marco posible.",
  "agency-intention": "¿Fue accidental o intencional? ¿Fue mi acción o la de otro? Premotora, parietal, DMN, vmPFC y cíngulo anterior atribuyen agencia e intención, dando significado moral y social a acciones que de otro modo serían solo movimientos físicos.",
  "empathy-compassion": "Sentir con otro, comprender su estado y orientar una respuesta prosocial son procesos distintos aunque se superpongan. Ínsula, cíngulo anterior, TPJ, vmPFC y DMN participan con pesos distintos según si la empatía es afectiva, cognitiva o compasiva.",
  "social-anger": "La rabia social no es solo emoción intensa: implica interpretar una intención, evaluar daño o injusticia, y decidir si confrontar, inhibir o reparar. Amígdala, ínsula, cíngulo anterior y saliencia registran y amplifican; DLPFC y vmPFC intentan dar forma regulada a esa energía.",
  "shame-social": "La vergüenza necesita un observador, real o imaginado: el yo representado bajo la mirada ajena. DMN, vmPFC, ínsula y cíngulo anterior convergen cuando una evaluación social negativa toca la identidad, generando malestar corporal, necesidad de ocultarse o deseo de reparar.",
  "theory-of-mind": "Inferir qué cree, siente o pretende otra persona no ocurre en un solo lugar. DMN simula, TPJ actualiza lo que el otro sabe, vmPFC integra significado social, hipocampo aporta contexto y parietal separa perspectivas. La teoría de la mente es una coordinación, no un módulo.",
  "pragmatic-language": "Lo que se dice y lo que se comunica no siempre coinciden. Corteza auditiva, regiones temporoparietales, DMN, DLPFC e ínsula van del sonido al significado social: tono, ironía, intención conversacional y el contexto que cambia el sentido de cada frase.",
  "deception-trust-violation": "Mentir o detectar una mentira exige control, memoria, vigilancia y actualización de valor social al mismo tiempo. DLPFC, vmPFC, cíngulo anterior, amígdala, hipocampo y estriado gestionan tanto la estrategia engañosa como la sospecha ante ella.",
  "ingroup-outgroup": "La pertenencia grupal cambia percepción, memoria y valor: la misma acción puede interpretarse distinto según quién la haga. Fusiforme, amígdala, vmPFC, DMN, cíngulo anterior y estriado procesan identidad, distancia social y el costo o beneficio de pertenecer o excluir.",
  "prejudice-stigma": "El prejuicio se entiende mejor como interacción entre aprendizaje cultural, respuesta afectiva y control que como rasgo fijo. Amígdala, saliencia, fusiforme, cíngulo anterior, DLPFC y vmPFC participan en activar, detectar y regular sesgos ante categorías sociales.",
  "guilt-repair": "La culpa no es solo malestar: es una evaluación de qué hice, a quién afecté y qué debo reparar. vmPFC, cíngulo anterior, ínsula, DMN, hipocampo y DLPFC transforman ese malestar en una decisión de respuesta concreta.",
  "social-pride": "El orgullo social emerge cuando un logro adquiere valor ante otros, ante uno mismo o ante el grupo al que se pertenece. vmPFC, circuitos estriatales, DMN, hipocampo y cíngulo anterior construyen esa valoración y la anclan en una narrativa de identidad.",
  "social-repair": "Reparar una relación después de un conflicto requiere valorar el daño, contener el impulso y reconstruir la narrativa compartida. vmPFC, DLPFC, cíngulo anterior, ínsula, hipocampo y DMN convierten el malestar emocional en acción de restauración.",
  "moral-indignation": "La indignación moral se organiza alrededor de una norma violada o un daño injusto, no solo de emoción intensa. Ínsula, cíngulo anterior, amígdala, DLPFC, vmPFC y red de saliencia procesan la aversión, la norma y la demanda de corrección que caracterizan esta emoción.",
  "envy-social-comparison": "La misma recompensa puede sentirse como éxito o como poco, según qué tiene el otro. vmPFC, estriado, DMN, cíngulo anterior e ínsula procesan comparación social, discrepancia de estatus y el malestar asociado a percibir inequidad relativa.",
  "forgiveness-reconciliation": "Perdonar implica reevaluar intención, contener el impulso de castigo y reconstruir la historia de la relación. vmPFC, DLPFC, cíngulo anterior, amígdala, hipocampo y DMN forman la red que hace posible ese cambio de valoración.",
  "reputation-impression": "La reputación es memoria social con consecuencias para decisiones futuras: fusiforme, hipocampo, vmPFC, DMN y estriado mantienen y actualizan quién es alguien, qué hizo antes y cuánto vale confiar en esa persona de nuevo.",
  "fairness-punishment": "La justicia combina malestar, norma y decisión: sentir que algo es injusto no es suficiente —hay que decidir si actuar. Ínsula, cíngulo anterior, DLPFC, vmPFC y estriado procesan la aversión a la inequidad y el costo o valor motivacional de responder a ella.",
  "social-uncertainty": "En situaciones sociales ambiguas, el cerebro no espera certeza: actualiza interpretaciones en tiempo real. DLPFC, cíngulo anterior, saliencia, vmPFC, hipocampo y amígdala gestionan hipótesis, señales de error y vigilancia para navegar la incertidumbre interpersonal.",
  "interpersonal-synchrony": "Conversar o moverse juntos requiere anticipar cuándo actúa el otro, no solo responder. Cerebelo, premotora, parietal, corteza auditiva y circuitos estriatales hacen posible sincronía en el gesto, la voz y el turno conversacional.",
  "affective-mentalizing": "Leer la emoción de otro no es solo inferencia: combina simulación interna, resonancia corporal y actualización de perspectiva. DMN, ínsula, amígdala, TPJ, vmPFC y cíngulo anterior trabajan juntos para hacer de esa lectura algo más que una hipótesis fría.",
  "dominance-hierarchy": "La jerarquía se aprende como mapa social dinámico: quién puede amenazar, quién coopera, a quién conviene acercarse. Amígdala, estriado, vmPFC, cíngulo anterior e hipocampo procesan señales de poder y sumisión, y actualizan ese mapa según experiencia e historia relacional.",
  "trust-cooperation": "Confiar es apostar por una relación futura con información incompleta. vmPFC, estriado, hipocampo, DLPFC y fusiforme estiman valor de cooperar, recuerdan reputación previa e inhiben impulsos egoístas cuando la norma o el vínculo lo requieren.",
  "social-learning-memory": "La memoria social prioriza lo que permite predecir: quién es confiable, qué pasó antes, cómo responder la próxima vez. Hipocampo, DMN, estriado y fusiforme unen persona, historia y consecuencia en un mapa relacional disponible.",
  "rejection-exclusion": "La exclusión duele antes de ser interpretada: cíngulo anterior e ínsula registran malestar social de forma similar al dolor físico. Amígdala y saliencia amplifican la señal; DLPFC intenta regular la respuesta posterior a una experiencia que amenaza pertenencia y valor social.",
  "communication-health": "Las palabras y la voz pueden regular o activar estrés antes de ser procesadas conscientemente. Corteza auditiva, ínsula, cíngulo anterior, DLPFC y saliencia deciden si la señal comunica apoyo, amenaza o crítica, con consecuencias fisiológicas reales."
};
...
function setView(view) {
  ...
  const views = {
    ...
    coronal: { position: atlasBounds.center.clone().add(new THREE.Vector3(0, 0.05, 3.0)), target: atlasBounds.center.clone() },
...
function buildCoronalGroup() {
  ...
  const cortR = [
    ...
    [0.50, 0.64], [0.56, 0.50],
    [0.60, 0.34], [0.63, 0.18], [0.62, 0.04],
    [0.57,-0.06], [0.50,-0.17], [0.42,-0.27],
...
function showCoronalSection() {
  ...
  // Pause auto-spin.
  coronalSavedSpin = spinPaused;
  spinPaused = true;

  coronalGroup = buildCoronalGroup();
  coronalGroup.position.set(atlasBounds.center.x, atlasBounds.center.y, atlasBounds.center.z);
  scene.add(coronalGroup);

  // Hide everything else after adding the group so _setBrainVisible skips it.
  _setBrainVisible(false);
}
...
function hideCoronalSection() {
  ...
  _setBrainVisible(true);
  spinPaused = coronalSavedSpin;
}
...
function prepareImportedAtlas(root, label) {
  ...
  const _bsz = box.getSize(new THREE.Vector3());
  atlasBounds.boxHalf.set(_bsz.x / 2, _bsz.y / 2, _bsz.z / 2);
  atlasBounds.radius = Math.max(2.8, _bsz.length() * 0.5);
